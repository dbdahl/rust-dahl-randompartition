...
#[derive(Debug, Clone)]
pub struct Old3SpParameters<D: PredictiveProbabilityFunction + Clone> {
...
impl<D: PredictiveProbabilityFunction + Clone> Old3SpParameters<D> {
    pub fn new(
...
impl<D: PredictiveProbabilityFunction + Clone> FullConditional for Old3SpParameters<D> {
...
impl<D: PredictiveProbabilityFunction + Clone> PartitionSampler for Old3SpParameters<D> {
    fn sample<T: Rng>(&self, rng: &mut T) -> Clustering {
        engine_full(self, None, Some(rng)).0
    }
}

impl<D: PredictiveProbabilityFunction + Clone> ProbabilityMassFunction for Old3SpParameters<D> {
...
impl<D: PredictiveProbabilityFunction + Clone> NormalizedProbabilityMassFunction
    for Old3SpParameters<D>
{
}

impl<D: PredictiveProbabilityFunction + Clone> HasPermutation for Old3SpParameters<D> {
...
impl<D: PredictiveProbabilityFunction + Clone> HasVectorShrinkage for Old3SpParameters<D> {
...
mod tests {
    ...
    fn test_goodness_of_fit_constructive() {
        ...
        for target in Clustering::iter(n_items) {
            ...
            let parameters =
                Old3SpParameters::new(target, shrinkage, permutation, baseline_distribution)
                    .unwrap();
